package com.creek.simplifycommercetest.invoice;
 ...
 */
public class InvoiceService extends SimplifyCommerceService {

    public InvoiceService(final String publicKey, final String privateKey) {
